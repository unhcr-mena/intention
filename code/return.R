...
#rm(progres.case)
progres.case <- read.csv("data/progrescase-depart.csv")
#str(progres.case)
progres.case.or <- progres.case
## Filter the dataset for Syrians in Egytpt, Iraq, Jordan
progres.case<- progres.case[ progres.case$YearDepDate %in% c("2016","2017"),]
progres.case <- progres.case[progres.case$CountryAsylum %in% c("ARE", "IRQ", "JOR"), ]
progres.case <- progres.case[progres.case$CountryOrigin =="SYR", ]
...
str(progres.case$Case.size)
progres.case$Case.size <- car::recode(progres.case$Case.size,"'1'='Case.size.1';
                                 '2'='Case.size.2';
                                 '3'='Case.size.3.to.5';
                                 '4'='Case.size.3.to.5';
                                 '5'='Case.size.3.to.5';
                                 ...
                                 '15'='Case.size.6.and.more';
                                 '16'='Case.size.6.and.more';
                                 '17'='Case.size.6.and.more';
                                 '18'='Case.size.6.and.more';
                                 '19'='Case.size.6.and.more';
                                 '20'='Case.size.6.and.more';
                                 '21'='Case.size.6.and.more';
                                 '22'='Case.size.6.and.more';
                                 '23'='Case.size.6.and.more';
                                 '24'='Case.size.6.and.more';
                                 '25'='Case.size.6.and.more';
                                 '26'='Case.size.6.and.more';
                                 '27'='Case.size.6.and.more';
                                 '29'='Case.size.6.and.more';
                                 '36'='Case.size.6.and.more';
                                 '37'='Case.size.6.and.more';
                                 '42'='Case.size.6.and.more';
                                 '42'='Case.size.6.and.more';
                                 '46'='Case.size.6.and.more';
                                 '55'='Case.size.6.and.more';
                                 '59'='Case.size.6.and.more';
                                 '65'='Case.size.6.and.more';
                                 '67'='Case.size.6.and.more';
                                 '83'='Case.size.6.and.more';
                                 '42'='Case.size.6.and.more';
                                 NA = 'noData'")
...
progres.case$dependency <- as.factor(car::recode(progres.case$dependency,"'(0.0001,0.99]'='2.few.dependant';
...
progres.case$youthdependency <- as.factor(car::recode(progres.case$youthdependency,"'(0.0001,0.99]'='2.few.dependant';
                                                 '(0.99,1.1]'='3.half.dependant';
                                                 '(1.1,Inf]'='4.majority.dependant'"))
...
progres.case$elederndependency <- as.factor(car::recode(progres.case$elederndependency,"'(0.0001,0.99]'='2.few.dependant';
                                                   '(0.99,1.1]'='3.half.dependant';
                                                   '(1.1,Inf]'='4.majority.dependant'"))
...
progres.case$female.ratio <- as.factor(car::recode(progres.case$female.ratio,"'(0.0001,0.45]'='2.few.female'; '(0.45,0.55]'='3.half.female';
...
#rm(YearArrival)
progres.case$YearArrivalCategory2 <- as.factor(car::recode(progres.case$YearArrival,"'1899'='1900-1980';
                                                      '1928'='1900-1980';
                                                      '1932'='1900-1980';
                                                      '1935'='1900-1980';
                                                      '1936'='1900-1980';
...
progres.case$YearArrivalCategory <- as.factor(car::recode(progres.case$YearArrival,"'1899'='2011.or.before.or.unkown';
...
progres.case$CountryOriginCategory <- car::recode(progres.case$CountryOrigin,"'SYR'='SYR';
                                             'IRQ'='IRQ';
                                             'SOM'='HORN';
                                             'AFG'='AFG';
                                             'IRN'='IRN';
...
#progres.case$season <- car::recode(progres.case$season," 'January'='Q1';  'February'='Q1'; 'March'='Q1';
#                              'April'='Q2'; 'May'='Q2'; 'June'='Q2';
#                              'July'='Q3';  'August'='Q3';  'September'='Q3';
#                              'October'='Q4'; 'November'='Q4';  'December'='Q4' ")
progres.case$season <- car::recode(progres.case$season," 'Jan'='Q1';  'Feb'='Q1'; 'Mar'='Q1';
...
#levels(progres.case$Montharrival)
progres.case$season1 <- car::recode(progres.case$season1,"'Mar'='Spring'; 'Apr'='Spring';    'May'='Spring';
                               'Jun'='Summer'; 'Jul'='Summer';  'Aug'='Summer';
                               'Sep'='Autumn'; 'Oct'='Autumn'; 'Nov'='Autumn';
                               'Jan'='Winter';  'Feb'='Winter'; 'Dec'='Winter' ")
#progres.case$season1 <- car::recode(progres.case$season1,"'March'='Spring'; 'April'='Spring';    'May'='Spring';
...
progres.case$Montharrival <- car::recode(progres.case$Montharrival,"'January'='Jan';  'February'='Febr';'March'='Mar';
...
progres.case$edu_highest_t <- car::recode(progres.case$edu_highest_t,"'01' = 'Grade 1'; '02' = 'Grade 2';
...
#progres.case$edu_highest_t <- car::recode(progres.case$edu_highest_t,"'1 year (or Grade 1)' = 'Grade 1'; '2 year (or Grade 2)' = 'Grade 2';
...
progres.case$edu_highestcat <- car::recode(progres.case$edu_highest_t,"'Unknown'='Unknown';
...
progres.case$edu_highestcat <- car::recode(progres.case$edu_highest_t,"'Unknown'='Informal.Voca.or.Unknown';
...
#rm(dem_marriage)
#progres.case$dem_marriagecat <- car::recode(progres.case$dem_marriage,"'WD'='Widowed'; 'SN'='Single';'DV'='Divorced';'MA'='Married'; 'EG'='Engaged'; 'SR'='Separated'; 'CL'='Married'")
progres.case$dem_marriagecat <- car::recode(progres.case$dem_marriage,"'WD'='Widowed'; 'SN'='Single-Engaged';'DV'='Divorced-Separated-Unknown';'MA'='Married';
...
progres.case$dem_sex <- car::recode(progres.case$dem_sex,"'M'='Male'; 'F'='Female';'U'='Unknown'")
...
progres.case$dem_sex <- as.character(progres.case$dem_sex)
progres.case$dem_sex <- as.factor(progres.case$dem_sex)
...
### Remove factor
progres.case$coal1 <- as.character(progres.case$coal1)
progres.case$cool1 <- as.character(progres.case$cool1)
progres.case$coal2 <- as.character(progres.case$coal2)
progres.case$cool2 <- as.character(progres.case$cool2)

progres.case$CountryAsylum <- as.character(progres.case$CountryAsylum)

progres.case$CountryOrigin <- as.character(progres.case$CountryOrigin)
...
freq1.coo[freq1.coo$Freq <= 0.05, c("cool1Cat")] <- "Other.or.Unknown"
...
freq1.coa[freq1.coa$Freq <= 0.05, c("coal1Cat")] <- "Other.or.Unknown"
...
freq2.coo[freq2.coo$Freq <= 0.05, c("cool2Cat")] <- "Other.or.Unknown"
...
freq2.coa[freq2.coa$Freq <= 0.05, c("coal2Cat")] <- "Other.or.Unknown"
...
## prop.table(table(universe[, c("COO_L1") ], useNA = "ifany"))
...
###################################################
#names(progres.case)
write.csv(progres.case, file = "data/progrescase-depart1.csv",na="")


rm(freq1.coa,freq1.coo,freq2.coa,freq2.coo)


### Now merging with the active case - universe - from poststratify

progres.case.dep <- progres.case

progres.case.dep$return <- "Departed"
universe$return <- "Stayed"
names(universe)
progres.case.dep1 <- progres.case.dep[ , c("return", "cool1Cat", "CountryAsylum", "Case.size", "YearArrival","YearArrivalCategory", "female.ratio", "dependency", "dem_ethnCat", "occupationcat")]
universe1 <- universe[ , c("return", "COO_L1", "CountryAsylum", "Case.size", "YearArrival","YearArrivalCategory", "female.ratio", "dependency", "dem_ethnCat", "occupationcat")]
names(universe1)[2] <- "cool1Cat"
levels(as.factor(universe1$cool1Cat))
universe1[universe1$cool1Cat =="Other", c("cool1Cat")] <- "Other.or.Unknown"

progresall <- rbind(progres.case.dep1, universe1)
#str(progresall)
prop.table(table(progresall[, c("cool1Cat") ], useNA = "ifany"))

write.csv(progresall,"data/progresall.csv", row.names = FALSE)
